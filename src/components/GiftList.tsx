    ...
    <Section>
      ...
      <div className="relative">
        {offset > 0 && (
          <button
            onClick={prev}
            className="absolute -left-4 md:-left-6 top-1/2 -translate-y-1/2 z-10 w-11 h-11 rounded-full bg-[image:var(--gradient-cta)] text-white border-2 border-white shadow-[0_4px_14px_-4px_rgba(11,127,180,0.7)] flex items-center justify-center transition-all hover:brightness-110 hover:-translate-y-0.5"
            aria-label="Anterior"
          >
        ...
        {offset < maxOffset && (
          <button
            onClick={next}
            className="absolute -right-4 md:-right-6 top-1/2 -translate-y-1/2 z-10 w-11 h-11 rounded-full bg-[image:var(--gradient-cta)] text-white border-2 border-white shadow-[0_4px_14px_-4px_rgba(11,127,180,0.7)] flex items-center justify-center transition-all hover:brightness-110 hover:-translate-y-0.5"
